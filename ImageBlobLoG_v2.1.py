...
print("###################################################################")
print("#                                                                 #")
print("#                 Image blob detection program V2.1               #")
print("#                    Produced by Jian Xiong                       #")
print("#                                                                 #")
print("#                   Say no to duplicates! ʕ •ᴥ•ʔ                  #")
print("#                                                                 #")
print("###################################################################\n")
...
while queueSize != 0:
    ...
    try:
        ...
        final_array = np.unique(blobs_log, axis=0)
        # This unique remove duplicates in the array
        print("- Element in array after duplicates removal:" + str(len(final_array)))
        print("- csv file being produced")
        np.savetxt(filename+".csv", final_array, delimiter=",", fmt='%.2f')
