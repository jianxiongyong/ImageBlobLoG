...
print("###################################################################")
print("#                                                                 #")
print("#                 Image blob detection program (DEBUG)            #")
...
print("-> This version will show all the points as a red dot on a plot. This also doesn't remove duplicate points")
...
while True:
    ...
    try:
        ...
        saveCSV = input("Do you want to save the csv? (Y/N):")
        if saveCSV is 'y' or 'Y':
